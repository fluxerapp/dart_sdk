...
class PremiumApi {
  ...
  Future<Response<void>> cancelSubscription({ 
    ...
    final _path = r'/premium/cancel-subscription';
  ...
  Future<Response<UrlResponse>> createCustomerPortal({ 
    ...
    final _path = r'/premium/customer-portal';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PriceIdsResponse>> getPriceIds({ 
    ...
    final _path = r'/premium/price-ids';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PriceIdsResponse? _responseData;
    ...
    return Response<PriceIdsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> reactivateSubscription({ 
    ...
    final _path = r'/premium/reactivate-subscription';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> rejoinOperatorGuild({ 
    ...
    final _path = r'/premium/operator/rejoin';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> rejoinVisionaryGuild({ 
    ...
    final _path = r'/premium/visionary/rejoin';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
