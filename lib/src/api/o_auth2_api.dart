...
class OAuth2Api {
  ...
  Future<Response<ApplicationResponse>> createOauthApplication({ 
    ...
    final _path = r'/oauth2/applications';
  ...
  Future<Response<ApplicationsMeResponse>> getCurrentUserApplications({ 
    ...
    ApplicationsMeResponse? _responseData;
    ...
    return Response<ApplicationsMeResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<OAuth2MeResponse>> getCurrentUserOauth2({ 
    ...
    OAuth2MeResponse? _responseData;
    ...
    return Response<OAuth2MeResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<OAuth2UserInfoResponse>> getOauth2Userinfo({ 
    ...
    OAuth2UserInfoResponse? _responseData;
    ...
    return Response<OAuth2UserInfoResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ApplicationPublicResponse>> getPublicApplication({ 
    ...
    ApplicationPublicResponse? _responseData;
    ...
    return Response<ApplicationPublicResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<OAuth2IntrospectResponse>> introspectOauth2Token({ 
    ...
    final _path = r'/oauth2/introspect';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    OAuth2IntrospectResponse? _responseData;
    ...
    return Response<OAuth2IntrospectResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<ApplicationResponse>>> listUserApplications({ 
    ...
    final _path = r'/users/@me/applications';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<ApplicationResponse>>> listUserApplications2({ 
    ...
    final _path = r'/oauth2/applications/@me';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<OAuth2AuthorizationResponse>>> listUserOauth2Authorizations({ 
    ...
    final _path = r'/oauth2/@me/authorizations';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<OAuth2AuthorizationResponse>? _responseData;
    ...
    return Response<BuiltList<OAuth2AuthorizationResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<OAuth2ConsentResponse>> provideOauth2Consent({ 
    ...
    final _path = r'/oauth2/authorize/consent';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    OAuth2ConsentResponse? _responseData;
    ...
    return Response<OAuth2ConsentResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BotTokenResetResponse>> resetBotToken2({ 
    ...
    BotTokenResetResponse? _responseData;
    ...
    return Response<BotTokenResetResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> revokeOauth2Token({ 
    ...
    final _path = r'/oauth2/token/revoke';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BotProfileResponse>> updateBotProfile({ 
    ...
    BotProfileResponse? _responseData;
    ...
    return Response<BotProfileResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
