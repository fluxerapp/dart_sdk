...
class ConnectionsApi {
  ...
  Future<Response<BlueskyAuthorizeResponse>> authorizeBlueskyConnection({ 
    ...
    final _path = r'/users/@me/connections/bluesky/authorize';
    ...
    BlueskyAuthorizeResponse? _responseData;
    ...
    return Response<BlueskyAuthorizeResponse>(
      data: _responseData,
  ...
  Future<Response<ConnectionVerificationResponse>> initiateConnection({ 
    ...
    final _path = r'/users/@me/connections';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ConnectionVerificationResponse? _responseData;
    ...
    return Response<ConnectionVerificationResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> reorderConnections({ 
    ...
    final _path = r'/users/@me/connections/reorder';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ConnectionResponse>> verifyAndCreateConnection({ 
    ...
    final _path = r'/users/@me/connections/verify';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
