...
class DonationsApi {
  ...
  Future<Response<DonationCheckoutResponse>> createDonationCheckout({
    ...
    final _path = r'/donations/checkout';
    ...
    DonationCheckoutResponse? _responseData;
    ...
    return Response<DonationCheckoutResponse>(
      data: _responseData,
  ...
  Future<Response<void>> manageDonation({
    ...
    final _path = r'/donations/manage';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> requestDonationMagicLink({
    ...
    final _path = r'/donations/request-link';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
