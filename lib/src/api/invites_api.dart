...
class InvitesApi {
  ...
  Future<Response<InviteResponseSchema>> acceptInvite({ 
    ...
    InviteResponseSchema? _responseData;
    ...
    return Response<InviteResponseSchema>(
      data: _responseData,
  ...
  Future<Response<InviteMetadataResponseSchema>> createChannelInvite({ 
    ...
    InviteMetadataResponseSchema? _responseData;
    ...
    return Response<InviteMetadataResponseSchema>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<InviteMetadataResponseSchema>>> listChannelInvites({ 
    ...
    BuiltList<InviteMetadataResponseSchema>? _responseData;
    ...
    return Response<BuiltList<InviteMetadataResponseSchema>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
