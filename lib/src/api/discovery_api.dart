...
class DiscoveryApi {
  ...
  Future<Response<DiscoveryStatusResponse>> getDiscoveryStatus({
    ...
    DiscoveryStatusResponse? _responseData;
    ...
    return Response<DiscoveryStatusResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<DiscoveryCategoryResponse>>>
    ...
    final _path = r'/discovery/categories';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<DiscoveryCategoryResponse>? _responseData;
    ...
    return Response<BuiltList<DiscoveryCategoryResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<DiscoveryGuildListResponse>> searchDiscoveryGuilds({
    ...
    final _path = r'/discovery/guilds';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    DiscoveryGuildListResponse? _responseData;
    ...
    return Response<DiscoveryGuildListResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
