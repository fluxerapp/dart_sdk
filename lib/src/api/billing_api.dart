...
class BillingApi {
  ...
  Future<Response<UrlResponse>> createCheckoutSession({ 
    ...
    final _path = r'/stripe/checkout/subscription';
  ...
  Future<Response<UrlResponse>> createGiftCheckoutSession({ 
    ...
    final _path = r'/stripe/checkout/gift';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<WebhookReceivedResponse>> processStripeWebhook({ 
    ...
    WebhookReceivedResponse? _responseData;
    ...
    return Response<WebhookReceivedResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
