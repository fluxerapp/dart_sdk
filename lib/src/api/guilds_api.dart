...
class GuildsApi {
  ...
  Future<Response<GuildRoleResponse>> createGuildRole({
    ...
    GuildRoleResponse? _responseData;
  ...
  Future<Response<GuildMemberResponse>> getCurrentGuildMember({
    ...
    GuildMemberResponse? _responseData;
  ...
  Future<Response<GuildVanityURLResponse>> getGuildVanityUrl({
    ...
    GuildVanityURLResponse? _responseData;
    ...
    return Response<GuildVanityURLResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<GuildAuditLogListResponse>> listGuildAuditLogs({
    ...
    GuildAuditLogListResponse? _responseData;
    ...
    return Response<GuildAuditLogListResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<GuildBanResponse>>> listGuildBans({
    ...
    BuiltList<GuildBanResponse>? _responseData;
    ...
    return Response<BuiltList<GuildBanResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<GuildMemberResponse>>> listGuildMembers2({
    ...
    BuiltList<GuildMemberResponse>? _responseData;
    ...
    return Response<BuiltList<GuildMemberResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<GuildRoleResponse>>> listGuildRoles({
    ...
    BuiltList<GuildRoleResponse>? _responseData;
    ...
    return Response<BuiltList<GuildRoleResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<GuildResponse>>> listGuilds({
    ...
    BuiltList<GuildResponse>? _responseData;
    ...
    return Response<BuiltList<GuildResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<GuildMemberSearchResponse>> searchGuildMembers({
    ...
    GuildMemberSearchResponse? _responseData;
    ...
    return Response<GuildMemberSearchResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<GuildVanityURLUpdateResponse>> updateGuildVanityUrl({
    ...
    GuildVanityURLUpdateResponse? _responseData;
    ...
    return Response<GuildVanityURLUpdateResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
