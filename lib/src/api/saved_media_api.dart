...
class SavedMediaApi {
  ...
  const SavedMediaApi(this._dio, this._serializers);
  ...
  Future<Response<FavoriteMemeResponse>> createMemeFromMessage({
    ...
    FavoriteMemeResponse? _responseData;
    ...
    return Response<FavoriteMemeResponse>(
      data: _responseData,
  ...
  Future<Response<BuiltList<FavoriteMemeResponse>>> listFavoriteMemes({
    ...
    BuiltList<FavoriteMemeResponse>? _responseData;
    ...
    return Response<BuiltList<FavoriteMemeResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
