...
class TenorApi {
  ...
  const TenorApi(this._dio, this._serializers);
  ...
  Future<Response<TenorFeaturedResponse>> getTenorFeatured({ 
    ...
    TenorFeaturedResponse? _responseData;
    ...
    return Response<TenorFeaturedResponse>(
      data: _responseData,
  ...
  Future<Response<BuiltList<TenorGifResponse>>> getTenorTrendingGifs({ 
    ...
    final _path = r'/tenor/trending-gifs';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<TenorGifResponse>? _responseData;
    ...
    return Response<BuiltList<TenorGifResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> registerTenorGifShare({ 
    ...
    final _path = r'/tenor/register-share';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
