...
class _$ChannelCreateLinkRequestSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.type,
      specifiedType: const FullType(ChannelCreateLinkRequestTypeEnum),
    );
    yield r'name';
    yield serializers.serialize(
      object.name,
  ...
  void _deserializeProperties(
    ...
    required ChannelCreateLinkRequestBuilder result,
      ...
      switch (key) {
        case r'type':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(ChannelCreateLinkRequestTypeEnum),
          ) as ChannelCreateLinkRequestTypeEnum;
  ...
  @override
  ChannelCreateLinkRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ChannelCreateLinkRequestBuilder();
