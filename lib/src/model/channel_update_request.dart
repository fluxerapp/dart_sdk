...
/// * [name]
@BuiltValue()
abstract class ChannelUpdateRequest
    implements Built<ChannelUpdateRequest, ChannelUpdateRequestBuilder> {
  ...
  factory ChannelUpdateRequest([void updates(ChannelUpdateRequestBuilder b)]) =
      _$ChannelUpdateRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ChannelUpdateRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ChannelUpdateRequest> get serializer =>
      _$ChannelUpdateRequestSerializer();
}

class _$ChannelUpdateRequestSerializer
    implements PrimitiveSerializer<ChannelUpdateRequest> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
      Serializers serializers, ChannelUpdateRequest object) sync* {}
  ...
  ChannelUpdateRequest deserialize(
    ...
    final targetType = const FullType(OneOf, [
      FullType(ChannelUpdateTextRequest),
      FullType(ChannelUpdateVoiceRequest),
      FullType(ChannelUpdateCategoryRequest),
      FullType(ChannelUpdateLinkRequest),
      FullType(ChannelUpdateGroupDmRequest),
    ]);
...
class ChannelUpdateRequestTypeEnum extends EnumClass {
  ...
  static const ChannelUpdateRequestTypeEnum number0 =
      _$channelUpdateRequestTypeEnum_number0;
  @BuiltValueEnumConst(wireNumber: 2)
  static const ChannelUpdateRequestTypeEnum number2 =
      _$channelUpdateRequestTypeEnum_number2;
  @BuiltValueEnumConst(wireNumber: 4)
  static const ChannelUpdateRequestTypeEnum number4 =
      _$channelUpdateRequestTypeEnum_number4;
  @BuiltValueEnumConst(wireNumber: 998)
  static const ChannelUpdateRequestTypeEnum number998 =
      _$channelUpdateRequestTypeEnum_number998;
  @BuiltValueEnumConst(wireNumber: 3)
  static const ChannelUpdateRequestTypeEnum number3 =
      _$channelUpdateRequestTypeEnum_number3;

  static Serializer<ChannelUpdateRequestTypeEnum> get serializer =>
      _$channelUpdateRequestTypeEnumSerializer;

  const ChannelUpdateRequestTypeEnum._(String name) : super(name);

  static BuiltSet<ChannelUpdateRequestTypeEnum> get values =>
      _$channelUpdateRequestTypeEnumValues;
  static ChannelUpdateRequestTypeEnum valueOf(String name) =>
      _$channelUpdateRequestTypeEnumValueOf(name);
}
