...
const MessageBaseResponseSchemaTypeEnum
    _$messageBaseResponseSchemaTypeEnum_number0 =
    const MessageBaseResponseSchemaTypeEnum._('number0');
const MessageBaseResponseSchemaTypeEnum
    _$messageBaseResponseSchemaTypeEnum_number1 =
    const MessageBaseResponseSchemaTypeEnum._('number1');
const MessageBaseResponseSchemaTypeEnum
    _$messageBaseResponseSchemaTypeEnum_number2 =
    const MessageBaseResponseSchemaTypeEnum._('number2');
const MessageBaseResponseSchemaTypeEnum
    _$messageBaseResponseSchemaTypeEnum_number3 =
    const MessageBaseResponseSchemaTypeEnum._('number3');
const MessageBaseResponseSchemaTypeEnum
    _$messageBaseResponseSchemaTypeEnum_number4 =
    const MessageBaseResponseSchemaTypeEnum._('number4');
const MessageBaseResponseSchemaTypeEnum
    _$messageBaseResponseSchemaTypeEnum_number5 =
    const MessageBaseResponseSchemaTypeEnum._('number5');
const MessageBaseResponseSchemaTypeEnum
    _$messageBaseResponseSchemaTypeEnum_number6 =
    const MessageBaseResponseSchemaTypeEnum._('number6');
const MessageBaseResponseSchemaTypeEnum
    _$messageBaseResponseSchemaTypeEnum_number7 =
    const MessageBaseResponseSchemaTypeEnum._('number7');
const MessageBaseResponseSchemaTypeEnum
    _$messageBaseResponseSchemaTypeEnum_number19 =
    const MessageBaseResponseSchemaTypeEnum._('number19');

MessageBaseResponseSchemaTypeEnum _$messageBaseResponseSchemaTypeEnumValueOf(
    String name) {
  switch (name) {
    case 'number0':
      return _$messageBaseResponseSchemaTypeEnum_number0;
    case 'number1':
      return _$messageBaseResponseSchemaTypeEnum_number1;
    case 'number2':
      return _$messageBaseResponseSchemaTypeEnum_number2;
    case 'number3':
      return _$messageBaseResponseSchemaTypeEnum_number3;
    case 'number4':
      return _$messageBaseResponseSchemaTypeEnum_number4;
    case 'number5':
      return _$messageBaseResponseSchemaTypeEnum_number5;
    case 'number6':
      return _$messageBaseResponseSchemaTypeEnum_number6;
    case 'number7':
      return _$messageBaseResponseSchemaTypeEnum_number7;
    case 'number19':
      return _$messageBaseResponseSchemaTypeEnum_number19;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<MessageBaseResponseSchemaTypeEnum>
    _$messageBaseResponseSchemaTypeEnumValues = BuiltSet<
        MessageBaseResponseSchemaTypeEnum>(const <MessageBaseResponseSchemaTypeEnum>[
  _$messageBaseResponseSchemaTypeEnum_number0,
  _$messageBaseResponseSchemaTypeEnum_number1,
  _$messageBaseResponseSchemaTypeEnum_number2,
  _$messageBaseResponseSchemaTypeEnum_number3,
...
Serializer<MessageBaseResponseSchemaTypeEnum>
    _$messageBaseResponseSchemaTypeEnumSerializer =
    _$MessageBaseResponseSchemaTypeEnumSerializer();

class _$MessageBaseResponseSchemaTypeEnumSerializer
    implements PrimitiveSerializer<MessageBaseResponseSchemaTypeEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[MessageBaseResponseSchemaTypeEnum];
  @override
  final String wireName = 'MessageBaseResponseSchemaTypeEnum';

  @override
  Object serialize(
          Serializers serializers, MessageBaseResponseSchemaTypeEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  MessageBaseResponseSchemaTypeEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      MessageBaseResponseSchemaTypeEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$MessageBaseResponseSchema extends MessageBaseResponseSchema {
  @override
  final String id;
  @override
  ...
  @override
  final MessageBaseResponseSchemaTypeEnum type;
  @override
  final int flags;
  @override
  ...
  factory _$MessageBaseResponseSchema(
          [void Function(MessageBaseResponseSchemaBuilder)? updates]) =>
      (MessageBaseResponseSchemaBuilder()..update(updates))._build();

  _$MessageBaseResponseSchema._(
      {required this.id,
      ...
      : super._();
  @override
  MessageBaseResponseSchema rebuild(
          void Function(MessageBaseResponseSchemaBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MessageBaseResponseSchemaBuilder toBuilder() =>
      MessageBaseResponseSchemaBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MessageBaseResponseSchema &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MessageBaseResponseSchema')
          ..add('id', id)
...
class MessageBaseResponseSchemaBuilder
    implements
        Builder<MessageBaseResponseSchema, MessageBaseResponseSchemaBuilder> {
  _$MessageBaseResponseSchema? _$v;
  ...
  MessageBaseResponseSchemaTypeEnum? _type;
  MessageBaseResponseSchemaTypeEnum? get type => _$this._type;
  set type(MessageBaseResponseSchemaTypeEnum? type) => _$this._type = type;
  ...
  MessageBaseResponseSchemaBuilder() {
    MessageBaseResponseSchema._defaults(this);
  }

  MessageBaseResponseSchemaBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(MessageBaseResponseSchema other) {
    _$v = other as _$MessageBaseResponseSchema;
  }

  @override
  void update(void Function(MessageBaseResponseSchemaBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  MessageBaseResponseSchema build() => _build();

  _$MessageBaseResponseSchema _build() {
    _$MessageBaseResponseSchema _$result;
    try {
      _$result = _$v ??
          _$MessageBaseResponseSchema._(
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'MessageBaseResponseSchema', 'id'),
            channelId: BuiltValueNullFieldError.checkNotNull(
                channelId, r'MessageBaseResponseSchema', 'channelId'),
            author: author.build(),
            type: BuiltValueNullFieldError.checkNotNull(
                type, r'MessageBaseResponseSchema', 'type'),
            flags: BuiltValueNullFieldError.checkNotNull(
                flags, r'MessageBaseResponseSchema', 'flags'),
            content: BuiltValueNullFieldError.checkNotNull(
                content, r'MessageBaseResponseSchema', 'content'),
            timestamp: BuiltValueNullFieldError.checkNotNull(
                timestamp, r'MessageBaseResponseSchema', 'timestamp'),
            pinned: BuiltValueNullFieldError.checkNotNull(
                pinned, r'MessageBaseResponseSchema', 'pinned'),
            mentionEveryone: BuiltValueNullFieldError.checkNotNull(
                mentionEveryone,
                r'MessageBaseResponseSchema',
                'mentionEveryone'),
            webhookId: webhookId,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'MessageBaseResponseSchema', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
