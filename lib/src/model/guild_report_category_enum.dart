...
class GuildReportCategoryEnum extends EnumClass {
  ...
  static const GuildReportCategoryEnum extremistCommunity = _$extremistCommunity;
  /// Category of the guild report
  ...
  static const GuildReportCategoryEnum malwareDistribution = _$malwareDistribution;
  /// Category of the guild report
  @BuiltValueEnumConst(wireName: r'other')
  static const GuildReportCategoryEnum other = _$other;

  static Serializer<GuildReportCategoryEnum> get serializer => _$guildReportCategoryEnumSerializer;
...
abstract class GuildReportCategoryEnumMixin = Object with _$GuildReportCategoryEnumMixin;
