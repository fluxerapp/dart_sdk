...
class _$BlueskyAuthorizeResponseSerializer implements PrimitiveSerializer<BlueskyAuthorizeResponse> {
  ...
  void _deserializeProperties(
    ...
    required BlueskyAuthorizeResponseBuilder result,
  ...
  @override
  BlueskyAuthorizeResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BlueskyAuthorizeResponseBuilder();
