...
/// * [smsPhoneHint]
@BuiltValue()
abstract class AuthRegisterResponse
    implements Built<AuthRegisterResponse, AuthRegisterResponseBuilder> {
  /// One Of [AuthMfaRequiredResponse], [AuthTokenWithUserIdResponse]
  OneOf get oneOf;

  AuthRegisterResponse._();

  factory AuthRegisterResponse([void updates(AuthRegisterResponseBuilder b)]) =
      _$AuthRegisterResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AuthRegisterResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AuthRegisterResponse> get serializer =>
      _$AuthRegisterResponseSerializer();
}

class _$AuthRegisterResponseSerializer
    implements PrimitiveSerializer<AuthRegisterResponse> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
      Serializers serializers, AuthRegisterResponse object) sync* {}
...
class AuthRegisterResponseMfaEnum extends EnumClass {
  ...
  static const AuthRegisterResponseMfaEnum true_ =
      _$authRegisterResponseMfaEnum_true_;

  static Serializer<AuthRegisterResponseMfaEnum> get serializer =>
      _$authRegisterResponseMfaEnumSerializer;

  const AuthRegisterResponseMfaEnum._(String name) : super(name);

  static BuiltSet<AuthRegisterResponseMfaEnum> get values =>
      _$authRegisterResponseMfaEnumValues;
  static AuthRegisterResponseMfaEnum valueOf(String name) =>
      _$authRegisterResponseMfaEnumValueOf(name);
}
