...
/// * [referencedMessage]
@BuiltValue()
abstract class PreloadMessagesResponseValue
    implements
        Built<PreloadMessagesResponseValue,
  ...
  factory PreloadMessagesResponseValue(
          [void updates(PreloadMessagesResponseValueBuilder b)]) =
      _$PreloadMessagesResponseValue;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PreloadMessagesResponseValueBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PreloadMessagesResponseValue> get serializer =>
      _$PreloadMessagesResponseValueSerializer();
}

class _$PreloadMessagesResponseValueSerializer
    implements PrimitiveSerializer<PreloadMessagesResponseValue> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
      Serializers serializers, PreloadMessagesResponseValue object) sync* {}
  ...
  PreloadMessagesResponseValue deserialize(
    ...
    final targetType = const FullType(AnyOf, [
      FullType.nullable(MessageResponseSchema),
    ]);
...
class PreloadMessagesResponseValueTypeEnum extends EnumClass {
  ...
  static const PreloadMessagesResponseValueTypeEnum number0 =
      _$preloadMessagesResponseValueTypeEnum_number0;

  /// The type of message
  @BuiltValueEnumConst(wireNumber: 1)
  static const PreloadMessagesResponseValueTypeEnum number1 =
      _$preloadMessagesResponseValueTypeEnum_number1;

  /// The type of message
  @BuiltValueEnumConst(wireNumber: 2)
  static const PreloadMessagesResponseValueTypeEnum number2 =
      _$preloadMessagesResponseValueTypeEnum_number2;

  /// The type of message
  @BuiltValueEnumConst(wireNumber: 3)
  static const PreloadMessagesResponseValueTypeEnum number3 =
      _$preloadMessagesResponseValueTypeEnum_number3;

  /// The type of message
  @BuiltValueEnumConst(wireNumber: 4)
  static const PreloadMessagesResponseValueTypeEnum number4 =
      _$preloadMessagesResponseValueTypeEnum_number4;

  /// The type of message
  @BuiltValueEnumConst(wireNumber: 5)
  static const PreloadMessagesResponseValueTypeEnum number5 =
      _$preloadMessagesResponseValueTypeEnum_number5;

  /// The type of message
  @BuiltValueEnumConst(wireNumber: 6)
  static const PreloadMessagesResponseValueTypeEnum number6 =
      _$preloadMessagesResponseValueTypeEnum_number6;

  /// The type of message
  @BuiltValueEnumConst(wireNumber: 7)
  static const PreloadMessagesResponseValueTypeEnum number7 =
      _$preloadMessagesResponseValueTypeEnum_number7;

  /// The type of message
  @BuiltValueEnumConst(wireNumber: 19)
  static const PreloadMessagesResponseValueTypeEnum number19 =
      _$preloadMessagesResponseValueTypeEnum_number19;

  static Serializer<PreloadMessagesResponseValueTypeEnum> get serializer =>
      _$preloadMessagesResponseValueTypeEnumSerializer;

  const PreloadMessagesResponseValueTypeEnum._(String name) : super(name);

  static BuiltSet<PreloadMessagesResponseValueTypeEnum> get values =>
      _$preloadMessagesResponseValueTypeEnumValues;
  static PreloadMessagesResponseValueTypeEnum valueOf(String name) =>
      _$preloadMessagesResponseValueTypeEnumValueOf(name);
}
