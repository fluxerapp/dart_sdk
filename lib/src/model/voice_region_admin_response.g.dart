...
class _$VoiceRegionAdminResponse extends VoiceRegionAdminResponse {
  @override
  final String id;
  @override
  final String name;
  ...
  factory _$VoiceRegionAdminResponse(
          [void Function(VoiceRegionAdminResponseBuilder)? updates]) =>
      (VoiceRegionAdminResponseBuilder()..update(updates))._build();

  _$VoiceRegionAdminResponse._(
      {required this.id,
      required this.name,
      required this.emoji,
      ...
      : super._();
  @override
  VoiceRegionAdminResponse rebuild(
          void Function(VoiceRegionAdminResponseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  VoiceRegionAdminResponseBuilder toBuilder() =>
      VoiceRegionAdminResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is VoiceRegionAdminResponse &&
        id == other.id &&
        name == other.name &&
        emoji == other.emoji &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'VoiceRegionAdminResponse')
          ..add('id', id)
          ..add('name', name)
          ..add('emoji', emoji)
...
class VoiceRegionAdminResponseBuilder
    implements
        Builder<VoiceRegionAdminResponse, VoiceRegionAdminResponseBuilder> {
  _$VoiceRegionAdminResponse? _$v;
  ...
  VoiceRegionAdminResponseBuilder() {
    VoiceRegionAdminResponse._defaults(this);
  }

  VoiceRegionAdminResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _name = $v.name;
  ...
  @override
  void replace(VoiceRegionAdminResponse other) {
    _$v = other as _$VoiceRegionAdminResponse;
  }

  @override
  void update(void Function(VoiceRegionAdminResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  VoiceRegionAdminResponse build() => _build();

  _$VoiceRegionAdminResponse _build() {
    _$VoiceRegionAdminResponse _$result;
    try {
      _$result = _$v ??
          _$VoiceRegionAdminResponse._(
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'VoiceRegionAdminResponse', 'id'),
            name: BuiltValueNullFieldError.checkNotNull(
                name, r'VoiceRegionAdminResponse', 'name'),
            emoji: BuiltValueNullFieldError.checkNotNull(
                emoji, r'VoiceRegionAdminResponse', 'emoji'),
            latitude: BuiltValueNullFieldError.checkNotNull(
                latitude, r'VoiceRegionAdminResponse', 'latitude'),
            longitude: BuiltValueNullFieldError.checkNotNull(
                longitude, r'VoiceRegionAdminResponse', 'longitude'),
            isDefault: BuiltValueNullFieldError.checkNotNull(
                isDefault, r'VoiceRegionAdminResponse', 'isDefault'),
            vipOnly: BuiltValueNullFieldError.checkNotNull(
                vipOnly, r'VoiceRegionAdminResponse', 'vipOnly'),
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'VoiceRegionAdminResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
