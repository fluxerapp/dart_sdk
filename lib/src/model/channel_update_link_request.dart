...
part 'channel_update_link_request.g.dart';
...
class _$ChannelUpdateLinkRequestSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.type,
      specifiedType: const FullType(ChannelUpdateLinkRequestTypeEnum),
    );
  ...
  void _deserializeProperties(
    ...
    required ChannelUpdateLinkRequestBuilder result,
      ...
      switch (key) {
        case r'type':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(ChannelUpdateLinkRequestTypeEnum),
          ) as ChannelUpdateLinkRequestTypeEnum;
  ...
  @override
  ChannelUpdateLinkRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ChannelUpdateLinkRequestBuilder();
