...
@BuiltValue()
abstract class IndexRefreshStatusResponse
    implements
        Built<IndexRefreshStatusResponse, IndexRefreshStatusResponseBuilder> {
  /// One Of [IndexRefreshStatusResponseOneOf], [IndexRefreshStatusResponseOneOf1]
  OneOf get oneOf;

  IndexRefreshStatusResponse._();

  factory IndexRefreshStatusResponse(
          [void updates(IndexRefreshStatusResponseBuilder b)]) =
      _$IndexRefreshStatusResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IndexRefreshStatusResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IndexRefreshStatusResponse> get serializer =>
      _$IndexRefreshStatusResponseSerializer();
}

class _$IndexRefreshStatusResponseSerializer
    implements PrimitiveSerializer<IndexRefreshStatusResponse> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
      Serializers serializers, IndexRefreshStatusResponse object) sync* {}
  ...
  IndexRefreshStatusResponse deserialize(
    ...
    final targetType = const FullType(OneOf, [
      FullType(IndexRefreshStatusResponseOneOf),
      FullType(IndexRefreshStatusResponseOneOf1),
    ]);
...
class IndexRefreshStatusResponseStatusEnum extends EnumClass {
  ...
  static const IndexRefreshStatusResponseStatusEnum inProgress =
      _$indexRefreshStatusResponseStatusEnum_inProgress;

  /// Current status of the index refresh job
  @BuiltValueEnumConst(wireName: r'completed')
  static const IndexRefreshStatusResponseStatusEnum completed =
      _$indexRefreshStatusResponseStatusEnum_completed;

  /// Current status of the index refresh job
  @BuiltValueEnumConst(wireName: r'failed')
  static const IndexRefreshStatusResponseStatusEnum failed =
      _$indexRefreshStatusResponseStatusEnum_failed;

  static Serializer<IndexRefreshStatusResponseStatusEnum> get serializer =>
      _$indexRefreshStatusResponseStatusEnumSerializer;

  const IndexRefreshStatusResponseStatusEnum._(String name) : super(name);

  static BuiltSet<IndexRefreshStatusResponseStatusEnum> get values =>
      _$indexRefreshStatusResponseStatusEnumValues;
  static IndexRefreshStatusResponseStatusEnum valueOf(String name) =>
      _$indexRefreshStatusResponseStatusEnumValueOf(name);
}
