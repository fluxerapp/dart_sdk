...
const ChannelPinMessageResponseTypeEnum
    _$channelPinMessageResponseTypeEnum_number0 =
    const ChannelPinMessageResponseTypeEnum._('number0');
const ChannelPinMessageResponseTypeEnum
    _$channelPinMessageResponseTypeEnum_number1 =
    const ChannelPinMessageResponseTypeEnum._('number1');
const ChannelPinMessageResponseTypeEnum
    _$channelPinMessageResponseTypeEnum_number2 =
    const ChannelPinMessageResponseTypeEnum._('number2');
const ChannelPinMessageResponseTypeEnum
    _$channelPinMessageResponseTypeEnum_number3 =
    const ChannelPinMessageResponseTypeEnum._('number3');
const ChannelPinMessageResponseTypeEnum
    _$channelPinMessageResponseTypeEnum_number4 =
    const ChannelPinMessageResponseTypeEnum._('number4');
const ChannelPinMessageResponseTypeEnum
    _$channelPinMessageResponseTypeEnum_number5 =
    const ChannelPinMessageResponseTypeEnum._('number5');
const ChannelPinMessageResponseTypeEnum
    _$channelPinMessageResponseTypeEnum_number6 =
    const ChannelPinMessageResponseTypeEnum._('number6');
const ChannelPinMessageResponseTypeEnum
    _$channelPinMessageResponseTypeEnum_number7 =
    const ChannelPinMessageResponseTypeEnum._('number7');
const ChannelPinMessageResponseTypeEnum
    _$channelPinMessageResponseTypeEnum_number19 =
    const ChannelPinMessageResponseTypeEnum._('number19');

ChannelPinMessageResponseTypeEnum _$channelPinMessageResponseTypeEnumValueOf(
    String name) {
  switch (name) {
    case 'number0':
      return _$channelPinMessageResponseTypeEnum_number0;
    case 'number1':
      return _$channelPinMessageResponseTypeEnum_number1;
    case 'number2':
      return _$channelPinMessageResponseTypeEnum_number2;
    case 'number3':
      return _$channelPinMessageResponseTypeEnum_number3;
    case 'number4':
      return _$channelPinMessageResponseTypeEnum_number4;
    case 'number5':
      return _$channelPinMessageResponseTypeEnum_number5;
    case 'number6':
      return _$channelPinMessageResponseTypeEnum_number6;
    case 'number7':
      return _$channelPinMessageResponseTypeEnum_number7;
    case 'number19':
      return _$channelPinMessageResponseTypeEnum_number19;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<ChannelPinMessageResponseTypeEnum>
    _$channelPinMessageResponseTypeEnumValues = BuiltSet<
        ChannelPinMessageResponseTypeEnum>(const <ChannelPinMessageResponseTypeEnum>[
  _$channelPinMessageResponseTypeEnum_number0,
  _$channelPinMessageResponseTypeEnum_number1,
  _$channelPinMessageResponseTypeEnum_number2,
  _$channelPinMessageResponseTypeEnum_number3,
...
Serializer<ChannelPinMessageResponseTypeEnum>
    _$channelPinMessageResponseTypeEnumSerializer =
    _$ChannelPinMessageResponseTypeEnumSerializer();

class _$ChannelPinMessageResponseTypeEnumSerializer
    implements PrimitiveSerializer<ChannelPinMessageResponseTypeEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[ChannelPinMessageResponseTypeEnum];
  @override
  final String wireName = 'ChannelPinMessageResponseTypeEnum';

  @override
  Object serialize(
          Serializers serializers, ChannelPinMessageResponseTypeEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  ChannelPinMessageResponseTypeEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      ChannelPinMessageResponseTypeEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$ChannelPinMessageResponse extends ChannelPinMessageResponse {
  @override
  final String id;
  @override
  ...
  @override
  final ChannelPinMessageResponseTypeEnum type;
  @override
  final int flags;
  @override
  ...
  factory _$ChannelPinMessageResponse(
          [void Function(ChannelPinMessageResponseBuilder)? updates]) =>
      (ChannelPinMessageResponseBuilder()..update(updates))._build();

  _$ChannelPinMessageResponse._(
      {required this.id,
      ...
      : super._();
  @override
  ChannelPinMessageResponse rebuild(
          void Function(ChannelPinMessageResponseBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ChannelPinMessageResponseBuilder toBuilder() =>
      ChannelPinMessageResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ChannelPinMessageResponse &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ChannelPinMessageResponse')
          ..add('id', id)
...
class ChannelPinMessageResponseBuilder
    implements
        Builder<ChannelPinMessageResponse, ChannelPinMessageResponseBuilder> {
  _$ChannelPinMessageResponse? _$v;
  ...
  ChannelPinMessageResponseTypeEnum? _type;
  ChannelPinMessageResponseTypeEnum? get type => _$this._type;
  set type(ChannelPinMessageResponseTypeEnum? type) => _$this._type = type;
  ...
  ChannelPinMessageResponseBuilder() {
    ChannelPinMessageResponse._defaults(this);
  }

  ChannelPinMessageResponseBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(ChannelPinMessageResponse other) {
    _$v = other as _$ChannelPinMessageResponse;
  }

  @override
  void update(void Function(ChannelPinMessageResponseBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ChannelPinMessageResponse build() => _build();

  _$ChannelPinMessageResponse _build() {
    _$ChannelPinMessageResponse _$result;
    try {
      _$result = _$v ??
          _$ChannelPinMessageResponse._(
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'ChannelPinMessageResponse', 'id'),
            channelId: BuiltValueNullFieldError.checkNotNull(
                channelId, r'ChannelPinMessageResponse', 'channelId'),
            author: author.build(),
            type: BuiltValueNullFieldError.checkNotNull(
                type, r'ChannelPinMessageResponse', 'type'),
            flags: BuiltValueNullFieldError.checkNotNull(
                flags, r'ChannelPinMessageResponse', 'flags'),
            content: BuiltValueNullFieldError.checkNotNull(
                content, r'ChannelPinMessageResponse', 'content'),
            timestamp: BuiltValueNullFieldError.checkNotNull(
                timestamp, r'ChannelPinMessageResponse', 'timestamp'),
            pinned: BuiltValueNullFieldError.checkNotNull(
                pinned, r'ChannelPinMessageResponse', 'pinned'),
            mentionEveryone: BuiltValueNullFieldError.checkNotNull(
                mentionEveryone,
                r'ChannelPinMessageResponse',
                'mentionEveryone'),
            webhookId: webhookId,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'ChannelPinMessageResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
