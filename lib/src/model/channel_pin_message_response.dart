...
abstract class ChannelPinMessageResponse implements Built<ChannelPinMessageResponse, ChannelPinMessageResponseBuilder> {
  ...
  ChannelPinMessageResponseTypeEnum get type;
...
class _$ChannelPinMessageResponseSerializer implements PrimitiveSerializer<ChannelPinMessageResponse> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.type,
      specifiedType: const FullType(ChannelPinMessageResponseTypeEnum),
    );
    yield r'flags';
    yield serializers.serialize(
      object.flags,
  ...
  void _deserializeProperties(
    ...
    required ChannelPinMessageResponseBuilder result,
      ...
      switch (key) {
        ...
        case r'type':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(ChannelPinMessageResponseTypeEnum),
          ) as ChannelPinMessageResponseTypeEnum;
  ...
  @override
  ChannelPinMessageResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ChannelPinMessageResponseBuilder();
