...
part of 'premium_effective_state.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PremiumEffectiveState _$PremiumEffectiveStateFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'PremiumEffectiveState',
  json,
  ($checkedConvert) {
    final val = PremiumEffectiveState(
      ...
      premiumBillingCycle: $checkedConvert(
        ...
        (v) => v == null
            ? null
            : PremiumEffectiveStatePremiumBillingCyclePremiumBillingCycle.fromJson(
                v as String,
              ),
      ),
...
Map<String, dynamic> _$PremiumEffectiveStateToJson(
  PremiumEffectiveState instance,
) => <String, dynamic>{
