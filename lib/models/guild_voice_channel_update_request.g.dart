...
part of 'guild_voice_channel_update_request.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GuildVoiceChannelUpdateRequest _$GuildVoiceChannelUpdateRequestFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'GuildVoiceChannelUpdateRequest',
  json,
  ($checkedConvert) {
    final val = GuildVoiceChannelUpdateRequest(
      type: $checkedConvert(
        'type',
        (v) =>
...
Map<String, dynamic> _$GuildVoiceChannelUpdateRequestToJson(
  GuildVoiceChannelUpdateRequest instance,
) => <String, dynamic>{
