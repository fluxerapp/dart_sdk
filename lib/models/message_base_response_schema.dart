...
@JsonSerializable()
class MessageBaseResponseSchema {
  ...
  factory MessageBaseResponseSchema.fromJson(Map<String, Object?> json) =>
      _$MessageBaseResponseSchemaFromJson(json);
  ...
  Map<String, Object?> toJson() => _$MessageBaseResponseSchemaToJson(this);
}
