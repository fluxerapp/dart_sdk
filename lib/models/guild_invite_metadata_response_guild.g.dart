...
GuildInviteMetadataResponseGuild _$GuildInviteMetadataResponseGuildFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'GuildInviteMetadataResponseGuild',
  json,
  ($checkedConvert) {
    final val = GuildInviteMetadataResponseGuild(
      id: $checkedConvert('id', (v) => v as String),
      name: $checkedConvert('name', (v) => v as String),
      splashCardAlignment: $checkedConvert(
        'splash_card_alignment',
        (v) =>
            GuildInviteMetadataResponseGuildSplashCardAlignmentSplashCardAlignment.fromJson(
              (v as num).toInt(),
            ),
      ),
...
Map<String, dynamic> _$GuildInviteMetadataResponseGuildToJson(
  GuildInviteMetadataResponseGuild instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
  'icon': ?instance.icon,
