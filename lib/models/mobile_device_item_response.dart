...
part 'mobile_device_item_response.g.dart';

@JsonSerializable()
class MobileDeviceItemResponse {
  const MobileDeviceItemResponse({
  ...
  factory MobileDeviceItemResponse.fromJson(Map<String, Object?> json) =>
      _$MobileDeviceItemResponseFromJson(json);
  ...
  Map<String, Object?> toJson() => _$MobileDeviceItemResponseToJson(this);
}
