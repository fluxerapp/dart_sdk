...
part 'discovery_admin_listed_guild_response.g.dart';

@JsonSerializable()
class DiscoveryAdminListedGuildResponse {
  const DiscoveryAdminListedGuildResponse({
  ...
  factory DiscoveryAdminListedGuildResponse.fromJson(
    Map<String, Object?> json,
  ) => _$DiscoveryAdminListedGuildResponseFromJson(json);
  ...
  /// Approval timestamp
  @JsonKey(includeIfNull: true, name: 'approved_at')
  final String? approvedAt;

  Map<String, Object?> toJson() =>
      _$DiscoveryAdminListedGuildResponseToJson(this);
}
