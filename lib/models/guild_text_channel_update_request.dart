...
part 'guild_text_channel_update_request.g.dart';

@JsonSerializable()
class GuildTextChannelUpdateRequest {
  const GuildTextChannelUpdateRequest({
    required this.type,
    this.topic,
    this.url,
    this.parentId,
  ...
  Map<String, Object?> toJson() => _$GuildTextChannelUpdateRequestToJson(this);
}
