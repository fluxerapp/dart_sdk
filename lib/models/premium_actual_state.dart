...
import 'premium_actual_state_premium_billing_cycle_premium_billing_cycle.dart';
import 'user_premium_types.dart';

part 'premium_actual_state.g.dart';

@JsonSerializable()
class PremiumActualState {
  const PremiumActualState({
  ...
  factory PremiumActualState.fromJson(Map<String, Object?> json) =>
      _$PremiumActualStateFromJson(json);
  ...
  /// ISO timestamp when actual premium access ends
  ...
  final PremiumActualStatePremiumBillingCyclePremiumBillingCycle?
  premiumBillingCycle;
  ...
  Map<String, Object?> toJson() => _$PremiumActualStateToJson(this);
}
