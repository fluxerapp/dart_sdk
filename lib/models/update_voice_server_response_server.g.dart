...
UpdateVoiceServerResponseServer _$UpdateVoiceServerResponseServerFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'UpdateVoiceServerResponseServer',
  json,
  ($checkedConvert) {
    final val = UpdateVoiceServerResponseServer(
...
Map<String, dynamic> _$UpdateVoiceServerResponseServerToJson(
  UpdateVoiceServerResponseServer instance,
) => <String, dynamic>{
