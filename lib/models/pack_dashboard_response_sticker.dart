...
@JsonSerializable()
class PackDashboardResponseSticker {
  ...
  factory PackDashboardResponseSticker.fromJson(Map<String, Object?> json) =>
      _$PackDashboardResponseStickerFromJson(json);
  ...
  Map<String, Object?> toJson() => _$PackDashboardResponseStickerToJson(this);
}
