...
@JsonEnum()
enum UserDsaReportRequestCategoryCategory {
  ...
  const UserDsaReportRequestCategoryCategory(this.json);

  factory UserDsaReportRequestCategoryCategory.fromJson(String json) =>
  ...
  static List<UserDsaReportRequestCategoryCategory> get $valuesDefined =>
