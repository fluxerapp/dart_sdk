...
part of 'sso_complete_response_user.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SsoCompleteResponseUser _$SsoCompleteResponseUserFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'SsoCompleteResponseUser',
  json,
  ($checkedConvert) {
    final val = SsoCompleteResponseUser(
...
Map<String, dynamic> _$SsoCompleteResponseUserToJson(
  SsoCompleteResponseUser instance,
) => <String, dynamic>{
  'id': instance.id,
