...
@JsonEnum()
enum ReportMessageRequestCategoryCategory {
  ...
  const ReportMessageRequestCategoryCategory(this.json);

  factory ReportMessageRequestCategoryCategory.fromJson(String json) =>
  ...
  static List<ReportMessageRequestCategoryCategory> get $valuesDefined =>
