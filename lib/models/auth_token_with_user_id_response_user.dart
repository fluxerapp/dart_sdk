...
part 'auth_token_with_user_id_response_user.g.dart';

@JsonSerializable()
class AuthTokenWithUserIdResponseUser {
  const AuthTokenWithUserIdResponseUser({
    required this.id,
  ...
  factory AuthTokenWithUserIdResponseUser.fromJson(Map<String, Object?> json) =>
      _$AuthTokenWithUserIdResponseUserFromJson(json);
  ...
  Map<String, Object?> toJson() =>
      _$AuthTokenWithUserIdResponseUserToJson(this);
}
