...
part of 'discovery_admin_listed_guild_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DiscoveryAdminListedGuildResponse _$DiscoveryAdminListedGuildResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'DiscoveryAdminListedGuildResponse',
  json,
  ($checkedConvert) {
    final val = DiscoveryAdminListedGuildResponse(
...
Map<String, dynamic> _$DiscoveryAdminListedGuildResponseToJson(
  DiscoveryAdminListedGuildResponse instance,
) => <String, dynamic>{
