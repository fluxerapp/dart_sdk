...
MessageSearchResultsResponseMessages
    _$MessageSearchResultsResponseMessagesFromJson(Map<String, dynamic> json) =>
        MessageSearchResultsResponseMessages(
          id: json['id'] as String,
          channelId: json['channel_id'] as String,
          author: UserPartialResponse.fromJson(
              json['author'] as Map<String, dynamic>),
          type: MessageSearchResultsResponseMessagesTypeType.fromJson(
          ...
          embeds: (json['embeds'] as List<dynamic>?)
              ?.map((e) =>
                  MessageEmbedResponse.fromJson(e as Map<String, dynamic>))
              .toList(),
          ...
          stickers: (json['stickers'] as List<dynamic>?)
              ?.map((e) =>
                  MessageStickerResponse.fromJson(e as Map<String, dynamic>))
              .toList(),
...
Map<String, dynamic> _$MessageSearchResultsResponseMessagesToJson(
        MessageSearchResultsResponseMessages instance) =>
    <String, dynamic>{
      'id': instance.id,
