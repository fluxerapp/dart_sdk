...
part 'guild_voice_channel_update_request.g.dart';

@JsonSerializable()
class GuildVoiceChannelUpdateRequest {
  ...
  factory GuildVoiceChannelUpdateRequest.fromJson(Map<String, Object?> json) =>
      _$GuildVoiceChannelUpdateRequestFromJson(json);
  ...
  Map<String, Object?> toJson() => _$GuildVoiceChannelUpdateRequestToJson(this);
}
