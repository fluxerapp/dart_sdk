...
part of 'guild_link_channel_update_request.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GuildLinkChannelUpdateRequest _$GuildLinkChannelUpdateRequestFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'GuildLinkChannelUpdateRequest',
  json,
  ($checkedConvert) {
    final val = GuildLinkChannelUpdateRequest(
      type: $checkedConvert(
        'type',
        (v) =>
...
Map<String, dynamic> _$GuildLinkChannelUpdateRequestToJson(
  GuildLinkChannelUpdateRequest instance,
) => <String, dynamic>{
