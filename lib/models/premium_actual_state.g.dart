...
part of 'premium_actual_state.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PremiumActualState _$PremiumActualStateFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'PremiumActualState',
  json,
  ($checkedConvert) {
    final val = PremiumActualState(
      ...
      premiumBillingCycle: $checkedConvert(
        ...
        (v) => v == null
            ? null
            : PremiumActualStatePremiumBillingCyclePremiumBillingCycle.fromJson(
                v as String,
              ),
      ),
...
Map<String, dynamic> _$PremiumActualStateToJson(PremiumActualState instance) =>
    <String, dynamic>{
