...
part of 'guild_category_channel_update_request.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GuildCategoryChannelUpdateRequest _$GuildCategoryChannelUpdateRequestFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'GuildCategoryChannelUpdateRequest',
  json,
  ($checkedConvert) {
    final val = GuildCategoryChannelUpdateRequest(
      type: $checkedConvert(
        'type',
...
Map<String, dynamic> _$GuildCategoryChannelUpdateRequestToJson(
  GuildCategoryChannelUpdateRequest instance,
) => <String, dynamic>{
