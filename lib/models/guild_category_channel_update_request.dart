...
part 'guild_category_channel_update_request.g.dart';

@JsonSerializable()
class GuildCategoryChannelUpdateRequest {
  const GuildCategoryChannelUpdateRequest({
    required this.type,
    this.topic,
    this.url,
    this.parentId,
  ...
  factory GuildCategoryChannelUpdateRequest.fromJson(
    Map<String, Object?> json,
  ) => _$GuildCategoryChannelUpdateRequestFromJson(json);
  ...
  Map<String, Object?> toJson() =>
      _$GuildCategoryChannelUpdateRequestToJson(this);
}
