...
@JsonSerializable()
class ChannelUpdateCategoryRequest {
  ...
  factory ChannelUpdateCategoryRequest.fromJson(Map<String, Object?> json) =>
      _$ChannelUpdateCategoryRequestFromJson(json);
  ...
  Map<String, Object?> toJson() => _$ChannelUpdateCategoryRequestToJson(this);
}
