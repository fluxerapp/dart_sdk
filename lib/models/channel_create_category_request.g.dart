...
ChannelCreateCategoryRequest _$ChannelCreateCategoryRequestFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'ChannelCreateCategoryRequest',
  json,
  ($checkedConvert) {
    final val = ChannelCreateCategoryRequest(
      type: $checkedConvert(
        'type',
        (v) =>
...
Map<String, dynamic> _$ChannelCreateCategoryRequestToJson(
  ChannelCreateCategoryRequest instance,
) => <String, dynamic>{
