...
@JsonSerializable()
class ChannelCreateVoiceRequest {
  ...
  factory ChannelCreateVoiceRequest.fromJson(Map<String, Object?> json) =>
  ...
  Map<String, Object?> toJson() => _$ChannelCreateVoiceRequestToJson(this);
}
