...
@JsonEnum()
enum ReportGuildRequestCategoryCategory {
  ...
  const ReportGuildRequestCategoryCategory(this.json);

  factory ReportGuildRequestCategoryCategory.fromJson(String json) =>
  ...
  static List<ReportGuildRequestCategoryCategory> get $valuesDefined =>
