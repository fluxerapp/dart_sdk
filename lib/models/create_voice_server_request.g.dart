...
CreateVoiceServerRequest _$CreateVoiceServerRequestFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'CreateVoiceServerRequest',
  json,
  ($checkedConvert) {
    final val = CreateVoiceServerRequest(
...
Map<String, dynamic> _$CreateVoiceServerRequestToJson(
  CreateVoiceServerRequest instance,
) => <String, dynamic>{
