...
@JsonEnum()
enum LocalizedCardPreapprovalContinueResponseRejectedReason {
  ...
  const LocalizedCardPreapprovalContinueResponseRejectedReason(this.json);

  factory LocalizedCardPreapprovalContinueResponseRejectedReason.fromJson(
    String json,
  ...
  static List<LocalizedCardPreapprovalContinueResponseRejectedReason>
