...
@JsonEnum()
enum GuildDsaReportRequestCategoryCategory {
  ...
  const GuildDsaReportRequestCategoryCategory(this.json);

  factory GuildDsaReportRequestCategoryCategory.fromJson(String json) =>
  ...
  static List<GuildDsaReportRequestCategoryCategory> get $valuesDefined =>
