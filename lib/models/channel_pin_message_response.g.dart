...
ChannelPinMessageResponse _$ChannelPinMessageResponseFromJson(
        Map<String, dynamic> json) =>
    ChannelPinMessageResponse(
      id: json['id'] as String,
      channelId: json['channel_id'] as String,
      author:
          UserPartialResponse.fromJson(json['author'] as Map<String, dynamic>),
      type: ChannelPinMessageResponseTypeType.fromJson(
...
Map<String, dynamic> _$ChannelPinMessageResponseToJson(
        ChannelPinMessageResponse instance) =>
    <String, dynamic>{
      'id': instance.id,
