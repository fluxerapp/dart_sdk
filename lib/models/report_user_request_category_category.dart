...
@JsonEnum()
enum ReportUserRequestCategoryCategory {
  ...
  const ReportUserRequestCategoryCategory(this.json);

  factory ReportUserRequestCategoryCategory.fromJson(String json) =>
  ...
  static List<ReportUserRequestCategoryCategory> get $valuesDefined =>
