...
part 'sso_complete_response_user.g.dart';

@JsonSerializable()
class SsoCompleteResponseUser {
  const SsoCompleteResponseUser({
    required this.id,
  ...
  factory SsoCompleteResponseUser.fromJson(Map<String, Object?> json) =>
      _$SsoCompleteResponseUserFromJson(json);
  ...
  Map<String, Object?> toJson() => _$SsoCompleteResponseUserToJson(this);
}
