...
part 'guild_template_response_serialized_source_guild.g.dart';

@JsonSerializable()
class GuildTemplateResponseSerializedSourceGuild {
  const GuildTemplateResponseSerializedSourceGuild({
    required this.name,
    required this.roles,
  ...
  factory GuildTemplateResponseSerializedSourceGuild.fromJson(
    Map<String, Object?> json,
  ) => _$GuildTemplateResponseSerializedSourceGuildFromJson(json);
  ...
  Map<String, Object?> toJson() =>
      _$GuildTemplateResponseSerializedSourceGuildToJson(this);
}
