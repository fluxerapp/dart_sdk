# fluxer_dart.model.UpdateVoiceServerRequest
...
**endpoint** | **String** | Client signal WebSocket endpoint URL for the voice server | [optional] 
**apiKey** | **String** | API key for authenticating with the voice server | [optional] 
**apiSecret** | **String** | API secret for authenticating with the voice server | [optional] 
