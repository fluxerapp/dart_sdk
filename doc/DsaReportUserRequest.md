# fluxer_dart.model.DsaReportUserRequest
...
**category** | [**UserReportCategoryEnum**](UserReportCategoryEnum.md) |  | 
...
**userTag** | **String** | Fluxer tag of the user being reported | [optional] 
